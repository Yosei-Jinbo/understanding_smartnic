"""Phase 14: cuStreamWaitValue32 wrapper for PyTorch CUDA streams.
...
注意:
  - CU_STREAM_WAIT_VALUE_FLUSH は A4000 (CAN_FLUSH_REMOTE_WRITES=0) でサポートされない
  - cuStreamWaitValue32 自体は sm_60 以降のすべての GPU で利用可能
"""
